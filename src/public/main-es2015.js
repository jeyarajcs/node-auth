...
class AccountService {
    ...
    login(email, password) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl}/admin/login`, { email, password })
    ...
    getAll() {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl}/user`);
    }
    getById(id) {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl}/user/${id}`);
    }
    update(id, params) {
        const options = {
        ...
        return this.http.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl}/user/${id}`, params, options)
    ...
    delete(id) {
        ...
        return this.http.delete(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl}/user/${id}`, options)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(x => {
...
module.exports = __webpack_require__(/*! D:\jeyaraj\docs\personal\node-auth-angular\src\main.ts */"./src/main.ts");
